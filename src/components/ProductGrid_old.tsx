...
import ProductCard_old from "@/components/ProductCard_old";
import classes from "@/components/ProductGrid_old.module.css";
              ...
              <div className={classes.products}>
                ...
                {fabricData
                  ...
                  .map((fabric, index: number) => {
                    return <ProductCard_old key={index} product={fabric} />;
                  })}
              </div>
