...
const manualTranslations: { [key: string]: { [key: string]: string } } = {
    ...
    'sherness_level': { 'tr': 'Işık geçirgenliği', 'ru': 'Уровень прозrачности', 'pl': 'Poziom przezroczystości', 'en': 'Sheerness Level' },
    'semi sheer': { 'tr': 'Yarı Geçirgen', 'ru': 'Полупрозрачный', 'pl': 'Półprzezroczysty', 'en': 'Semi Sheer' },
    'semi-sheer': { 'tr': 'Yarı Geçirgen', 'ru': 'Полупрозрачный', 'pl': 'Półprzezroczysty', 'en': 'Semi Sheer' },
    'sheer': { 'tr': 'Geçirgen', 'ru': 'Прозрачный', 'pl': 'Przezroczysty', 'en': 'Sheer' },
