...
const manualTranslations: { [key: string]: { [key: string]: string } } = {
    ...
    'fast_shipping': { 'tr': '24 Saatte Kargoda', 'ru': 'Отправка за 24 часа', 'pl': 'Wysyłka w 24h', 'en': 'Fast Shipping' },
    'fast shipping': { 'tr': '24 Saatte Kargoda', 'ru': 'Отправка за 24 часа', 'pl': 'Wysyłka w 24h', 'en': 'Fast Shipping' },
